...
if class == "MAGE" then
    ...
    for _, spellId in ipairs(fire_spells) do
        ...
        lib.indirectRefreshSpells[spellName][12654] = {
            ...
            rollbackMisses = true,
            condition = function(isMine, isCrit)
                return isCrit
            end,
...
Spell({ 13099, 13138, 16566 }, {
    duration = function(spellID)
        if spellID == 13138 then
            return 20 -- backfire
        elseif spellID == 16566 then
            return 30 -- backfire
        else
            return 10
        end
...
Spell({ 9484, 9485, 10955 }, {
    duration = function(spellID)
        if spellID == 9484 then
            return 30
        elseif spellID == 9485 then
            return 40
        else
            return 50
        end
...
Spell({ 339, 1062, 5195, 5196, 9852, 9853 }, {
    ...
    duration = function(spellID)
        if spellID == 339 then
            return 12
        elseif spellID == 1062 then
            return 15
        elseif spellID == 5195 then
            return 18
        elseif spellID == 5196 then
            return 21
        elseif spellID == 9852 then
            return 24
        else
            return 27
        end
...
Spell({ 2637, 18657, 18658 }, {
    pvpduration = 20,
    duration = function(spellID)
        if spellID == 2637 then
            return 20
        elseif spellID == 18657 then
            return 30
        else
            return 40
        end
...
Spell({ 5211, 6798, 8983 }, { stacking = true, -- stacking?
                              duration = function(spellID)
                                  ...
                                  if spellID == 5211 then
                                      return 2 + brutal_impact
                                  elseif spellID == 6798 then
                                      return 3 + brutal_impact
                                  else
                                      return 4 + brutal_impact
                                  end
                              end
}) -- Bash
...
Spell({ 772, 6546, 6547, 6548, 11572, 11573, 11574 }, { stacking = true,
                                                        duration = function(spellID)
                                                            if spellID == 772 then
                                                                return 9
                                                            elseif spellID == 6546 then
                                                                return 12
                                                            elseif spellID == 6547 then
                                                                return 15
                                                            elseif spellID == 6548 then
                                                                return 18
                                                            else
                                                                return 21
                                                            end
...
Spell({ 6343, 8198, 8204, 8205, 11580, 11581 }, {
    duration = function(spellID)
        if spellID == 6343 then
            return 10
        elseif spellID == 8198 then
            return 14
        elseif spellID == 8204 then
            return 18
        elseif spellID == 8205 then
            return 22
        elseif spellID == 11580 then
            return 26
        else
            return 30
        end
...
Spell({ 5760, 8692, 11398 }, {
    duration = function(spellID)
        if spellID == 5760 then
            return 10
        elseif spellID == 8692 then
            return 12
        else
            return 14
        end
...
Spell({ 2070, 6770, 11297 }, {
    ...
    duration = function(spellID)
        if spellID == 6770 then
            return 25 -- yes, Rank 1 spell id is 6770 actually
        elseif spellID == 2070 then
            return 35
        else
            return 45
        end
...
Spell({ 5782, 6213, 6215 }, {
    pvpduration = 20,
    duration = function(spellID)
        if spellID == 5782 then
            return 10
        elseif spellID == 6213 then
            return 15
        else
            return 20
        end
...
Spell({ 2878, 5627, 5627 }, {
    duration = function(spellID)
        if spellID == 2878 then
            return 10
        elseif spellID == 5627 then
            return 15
        else
            return 20
        end
...
Spell({ 853, 5588, 5589, 10308 }, {
    duration = function(spellID)
        if spellID == 853 then
            return 3
        elseif spellID == 5588 then
            return 4
        elseif spellID == 5589 then
            return 5
        else
            return 6
        end
...
Spell({ 1513, 14326, 14327 }, {
    pvpduration = 20,
    duration = function(spellID)
        if spellID == 1513 then
            return 10
        elseif spellID == 14326 then
            return 15
        else
            return 20
        end
...
Spell({ 3355, 14308, 14309 }, {
    ...
    duration = function(spellID, isSrcPlayer)
        ...
        if spellID == 3355 then
            return 10 * mul
        elseif spellID == 14308 then
            return 15 * mul
        else
            return 20 * mul
        end
...
Spell({ 133, 143, 145, 3140, 8400, 8401, 8402, 10148, 10149, 10150, 10151, 25306 }, {
    ...
    duration = function(spellID)
        if spellID == 133 then
            return 4
        elseif spellID == 143 then
            return 6
        elseif spellID == 145 then
            return 6
        else
            return 8
        end
...
Spell({ 118, 12824, 12825, 12826, 28270, 28271, 28272 }, {
    ...
    duration = function(spellID)
        if spellID == 118 then
            return 20
        elseif spellID == 12824 then
            return 30
        elseif spellID == 12825 then
            return 40
        else
            return 50
        end
...
if class == "MAGE" then
    ...
    Spell({ 12484, 12485, 12486 }, {
        duration = function(spellID, isSrcPlayer)
            if Talent(11185, 12487, 12488) > 0 then
                -- Don't show anything if mage doesn't have imp blizzard talent
...
Spell({ 116, 205, 837, 7322, 8406, 8407, 8408, 10179, 10180, 10181, 25304 }, {
    duration = function(spellID, isSrcPlayer)
        ...
        if spellID == 116 then
            return 5 + permafrost
        elseif spellID == 205 then
            return 6 + permafrost
        elseif spellID == 837 then
            return 6 + permafrost
        elseif spellID == 7322 then
            return 7 + permafrost
        elseif spellID == 8406 then
            return 7 + permafrost
        elseif spellID == 8407 then
            return 8 + permafrost
        elseif spellID == 8408 then
            return 8 + permafrost
        else
            return 9 + permafrost
        end
